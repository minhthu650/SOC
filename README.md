...
<body>
    ...
    <div id="control">
      ...
      <div id="mini-container">
        ...
        <svg id="mini-map" viewBox="0 0 700 380">
          ...
          <!-- lines (vẽ sau để luôn nổi trên box, không bị che) -->
          <!-- actors -> network -->
  ...
  <script>
    ...
    const STEP_INTERVAL = 2000; // 2s mỗi bước

    // đường đi của chấm tròn trên mini-map
    const pathsMini = {
      hids: [
        { x: 100, y: 40 },   // External
        { x: 280, y: 40 },   // Router
        ...
        { x: 320, y: 310 },  // Manager
        { x: 460, y: 310 },  // Indexer
        { x: 620, y: 190 },  // Dashboard
        { x: 620, y: 285 },  // MITRE
        { x: 620, y: 335 }   // Hunting
      ],
      fim: [
        { x: 110, y: 140 },  // Internal
        { x: 340, y: 140 },  // Victim
        { x: 435, y: 230 },  // FIM
        { x: 320, y: 310 },  // Manager
        { x: 460, y: 310 },  // Indexer
      ...
      malware: [
        { x: 110, y: 140 },  // Internal / local malware
        { x: 340, y: 140 },  // Victim
        { x: 570, y: 230 },  // Malware/IOC
        { x: 320, y: 310 },  // Manager
        { x: 460, y: 310 },  // Indexer
        { x: 620, y: 190 },  // Dashboard
        { x: 620, y: 285 },  // MITRE
    ...
    // mapping: mỗi scenario -> list các đoạn mũi tên tương ứng
    const pathSequences = {
      hids: [
        "p_ext_router",
        "p_router_fw",
    ...
    function runScenario(key) {
      ...
      // banner cảnh báo cho brute-force
      if (key === "hids") {
      ...
      scenario.steps.forEach((step, index) => {
        ...
        const timer = setTimeout(() => {
          ...
          // đánh dấu đoạn mũi tên đã đi qua (từ step index-1 -> index)
